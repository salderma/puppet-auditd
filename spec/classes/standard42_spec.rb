...
describe 'auditd' do
  ...
  describe 'Test standard installation' do
    it { should contain_package('auditd').with_ensure('present') }
  ...
  describe 'Test installation of a specific version' do
    ...
    it { should contain_package('auditd').with_ensure('1.0.42') }
  end
  ...
  describe 'Test standard installation with monitoring and firewalling' do
    ...
    it { should contain_firewall('auditd_tcp_42').with_enable('true') }
  end

  describe 'Test decommissioning - absent' do
    let(:params) { {:absent => true, :monitor => true , :firewall => true, :port => '42', :protocol => 'tcp'} }
    it 'should remove Package[auditd]' do should contain_package('auditd').with_ensure('absent') end
    ...
    it { should contain_firewall('auditd_tcp_42').with_enable('false') }
  end
  ...
  describe 'Test noops mode' do
    ...
    it { should contain_package('auditd').with_noop('true') }
    ...
    it { should contain_monitor__process('auditd_process').with_noop('true') }
    it { should contain_monitor__port('auditd_tcp_42').with_noop('true') }
    it { should contain_firewall('auditd_tcp_42').with_noop('true') }
  end
  ...
  describe 'Test Firewall Tools Integration' do
    ...
    it { should contain_firewall('auditd_tcp_42').with_tool('iptables') }
  end
